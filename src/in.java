...
public class in extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "NAME", "ADDRESS", "AGE", "GENDER", "CONT. NO", "ROOM NO"
            }
        ));
        jScrollPane2.setViewportView(jTable2);

        jLabel8.setText("INPATIENT REGISTRATION");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jTextField1.getText().equals("")){
            ...
            String sql="insert into `in`(`id`,`name`,`age`,`gen`,`add`,`cont`,`room`) values (?,?,?,?,?,?,?)";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            Connection cn=DriverManager.getConnection("jdbc:mysql://localhost:3306/hms","root","");
            PreparedStatement ps=cn.prepareStatement("select * from `in`");
            ResultSet rs=ps.executeQuery();
            DefaultTableModel tm=(DefaultTableModel)jTable2.getModel();
            tm.setRowCount(0);
            while(rs.next()){
                Object o[]={rs.getString("ID"),rs.getString("NAME"),rs.getString("ADD"),rs.getString("AGE"),rs.getString("GEN"),rs.getString("CONT"),rs.getString("ROOM")};
                tm.addRow(o);
            }
